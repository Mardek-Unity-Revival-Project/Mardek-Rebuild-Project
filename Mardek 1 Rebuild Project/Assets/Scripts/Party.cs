...
public class Party : MonoBehaviour
{
	...
	public void swapChar(Fighter swapOut, Fighter swapIn)
	{
	...
	public void removeChar(Fighter chara)
	{
		for (int i=0; i<listTotal; i++)
		{
	...
	public void partyAdd(Fighter chara, int index)
	{
		if (index < 4)
		{
	...
	public void partyRemove(Fighter chara)
	{
		for (int i=0; i<4; i++)
		{
